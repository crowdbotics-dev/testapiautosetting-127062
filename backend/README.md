...
## Project Structure
    ...
    ├── testapiautosetting_127062  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127062`
...
2. Clone this repo and `cd testapiautosetting_127062`
